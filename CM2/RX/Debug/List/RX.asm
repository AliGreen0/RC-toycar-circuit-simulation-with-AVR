...
; 0000 006C DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
...
; 0000 00BB // USART Baud Rate: 4800
; 0000 00BC UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 00BD UCSRB=(1<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(144)
	OUT  0xA,R30
...
_0xD:
	...
	LDI  R31,0
; 0000 00E1 
; 0000 00E2       case 1:               //DC motor1 forward
	CPI  R30,LOW(0x1)
	LDI  R26,HIGH(0x1)
	CPC  R31,R26
	BRNE _0x11
; 0000 00E3       PORTA=0x09;
	LDI  R30,LOW(9)
	CALL SUBOPT_0x0
...
; 0000 00E5       break;
	RJMP _0x10
; 0000 00E6 
; 0000 00E7       case 2:               //DC motor1 backward
_0x11:
	CPI  R30,LOW(0x2)
	LDI  R26,HIGH(0x2)
	CPC  R31,R26
	BRNE _0x12
; 0000 00E8       PORTA=0x06;
	LDI  R30,LOW(6)
	CALL SUBOPT_0x0
...
; 0000 00EA       break;
	RJMP _0x10
; 0000 00EB 
; 0000 00EC       case 3:               //DC motor2 forward
_0x12:
	CPI  R30,LOW(0x3)
	LDI  R26,HIGH(0x3)
	CPC  R31,R26
	BRNE _0x13
; 0000 00ED       PORTA=0x90;
	LDI  R30,LOW(144)
	CALL SUBOPT_0x0
...
; 0000 00EF       break;
	RJMP _0x10
; 0000 00F0 
; 0000 00F1       case 4:               //DC motor2 backward
_0x13:
	CPI  R30,LOW(0x4)
	LDI  R26,HIGH(0x4)
	CPC  R31,R26
	BRNE _0x14
; 0000 00F2       PORTA=0x60;
	LDI  R30,LOW(96)
	CALL SUBOPT_0x0
...
; 0000 00F4       break;
	RJMP _0x10
; 0000 00F5 
; 0000 00F6       case 5:               //DC motor1 forward      DC motor2 forward
_0x14:
	CPI  R30,LOW(0x5)
	LDI  R26,HIGH(0x5)
	CPC  R31,R26
	BRNE _0x15
; 0000 00F7       PORTA=0x99;
	LDI  R30,LOW(153)
	CALL SUBOPT_0x0
...
; 0000 00F9       break;
	RJMP _0x10
; 0000 00FA 
; 0000 00FB       case 6:               //DC motor1 forward      DC motor2 backward
_0x15:
	CPI  R30,LOW(0x6)
	LDI  R26,HIGH(0x6)
	CPC  R31,R26
	BRNE _0x16
; 0000 00FC       PORTA=0x69;
	LDI  R30,LOW(105)
	CALL SUBOPT_0x0
...
; 0000 00FE       break;
	RJMP _0x10
; 0000 00FF 
; 0000 0100       case 7:               //DC motor1 backward     DC motor2 forward
_0x16:
	CPI  R30,LOW(0x7)
	LDI  R26,HIGH(0x7)
	CPC  R31,R26
	BRNE _0x17
; 0000 0101       PORTA=0x96;
	LDI  R30,LOW(150)
	CALL SUBOPT_0x0
...
; 0000 0103       break;
	RJMP _0x10
; 0000 0104 
; 0000 0105       case 8:               //DC motor1 backward     DC motor2 backward
_0x17:
	CPI  R30,LOW(0x8)
	LDI  R26,HIGH(0x8)
	CPC  R31,R26
	BRNE _0x19
; 0000 0106       PORTA=0x66;
	LDI  R30,LOW(102)
	CALL SUBOPT_0x0
; 0000 0107       delay_ms(200);
; 0000 0108 
; 0000 0109       default :             //stop
_0x19:
; 0000 010A       PORTA=0x00;
	LDI  R30,LOW(0)
	OUT  0x1B,R30
; 0000 010B 
; 0000 010C       }
